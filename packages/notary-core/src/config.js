...
import { MasterEventBus } from 'notary-plugins-subsystem';
...
config.pluginsBus = new MasterEventBus(4000);
config.logger.info(`notary plugins sub-system for the master is up at :4000`);
